...
export const CATEGORIES = [
    { label: "Fashion & Clothing", icon: Shirt, slug: "fashion-clothing" },
    ...
    { label: "Art & Crafts", icon: Palette, slug: "art-crafts" },
    { label: "Jewelry", icon: Gem, slug: "jewelry" },
    { label: "Shoes & Bags", icon: ShoppingBag, slug: "shoes-bags" },
];
